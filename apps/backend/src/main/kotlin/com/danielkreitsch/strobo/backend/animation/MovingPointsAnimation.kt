...
class MovingPointsAnimation : Animation("moving-points", "Moving Points")
{
    ...
    {
        val originalColors = args.leds.colors.map { color -> Color(color.r, color.g, color.b, color.w) }.toTypedArray()
    ...
    private fun drawPoint(tick: Int, colors: Array<Color>, originalColors: Array<Color>, devicePosition: Int, offset: Int = 0)
    {
