...
const routes: Routes = [
  ...
  {
    path: 'music/settings',
    loadChildren: () => import('./pages/music-settings/music-settings.module').then( m => m.MusicSettingsPageModule)
  },
  {
    path: 'groups/new',
  ...
  {
    path: 'devices/new',
    loadChildren: () => import('./pages/register-device/register-device.module').then(m => m.AddDevicePageModule)
  },
  {
  ...
  {
    path: 'animations/new',
    loadChildren: () => import('./pages/create-animation/create-animation.module').then( m => m.CreateAnimationPageModule)
  },
  {
    path: 'animations/:id/edit',
    loadChildren: () => import('./pages/edit-animation/edit-animation.module').then( m => m.EditAnimationPageModule)
  },
  {
    path: 'animations/:id',
